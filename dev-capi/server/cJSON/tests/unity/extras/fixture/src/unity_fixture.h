...
#define TEST(group, name)                                                                                                                        \
  ...
  void TEST_##group##_##name##_run(void) {                                                                                                       \
    UnityTestRunner(TEST_##group##_SETUP, TEST_##group##_##name##_, TEST_##group##_TEAR_DOWN, "TEST(" #group ", " #name ")", TEST_GROUP_##group, \
...
#define IGNORE_TEST(group, name)                                                                                               \
  void TEST_##group##_##name##_(void);                                                                                         \
  void TEST_##group##_##name##_run(void);                                                                                      \
  void TEST_##group##_##name##_run(void) { UnityIgnoreTest("IGNORE_TEST(" #group ", " #name ")", TEST_GROUP_##group, #name); } \
  void TEST_##group##_##name##_(void)
