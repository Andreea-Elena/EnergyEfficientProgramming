...
HEADER_SAMPLE_PUT = """\
PUT /me/you/and/yourself?column_b=true&column_a=unu HTTP/1.1\r\n\
...
_epnt: testforme\r\n\
Content-Length: 79\r\n\r\n\
{"column_a":"andreea","column_b":"false","column_c":"arix","column_d":"a"}"""
...
def send_request(): 
    ...
    request = bytes(HEADER_SAMPLE_PUT,'UTF-8')
